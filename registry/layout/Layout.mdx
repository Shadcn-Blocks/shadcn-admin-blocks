...
1. Wrap your app (or story) in `<WorkspacesProvider>`.
...
### 🧱 Default Layout Without Organizations
...
<WorkspacesProvider>
  <LayoutBase>
    <LayoutSidebar>
      ...
      <LayoutSidebarContent>{/* ...menu items... */}</LayoutSidebarContent>
      <LayoutSidebarFooter user={/* user props */}>{/* footer items... */}</LayoutSidebarFooter>
    </LayoutSidebar>
